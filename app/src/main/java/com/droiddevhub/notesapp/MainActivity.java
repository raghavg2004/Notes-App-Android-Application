...
public class MainActivity extends AppCompatActivity implements PopupMenu.OnMenuItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ImageView aboutBtn = findViewById(R.id.aboutBtn);  // Get reference to about button
        ...
        aboutBtn.setOnClickListener(new View.OnClickListener() {  // Set click listener for about button
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(MainActivity.this, AboutActivity.class); // Start AboutActivity
